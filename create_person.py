...
if len(sys.argv) is not 1:
    ...
    'Ocp-Apim-Subscription-Key': '2cfe4243d20342c2b49aeda55a4647f8',
	}
	body = {}
	body['name'] = 'Person1'
	...
	conn.request("POST", "/face/v1.0/persongroups/test1/persons" ,json.dumps(body) , headers)
	...
	if isRecordExist == 1:                                                      # updating name and roll no
	    connect.execute("UPDATE Students SET personID = ?, Publickey = ? WHERE ID = ?",(res['personId'], publickey, extractId))
